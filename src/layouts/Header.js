          ...
          <div className="row">
            ...
            <div className="col-xs-6 col-sm-8 col-md-8 col-lg-8" style={{display: 'flex', justifyContent: 'flex-end', alignItems: 'center'}}>
              <div style={{
                ...
                {/* menu btn */}
                <a href="#" className="menu-btn" onClick={(e) => toggleMenu(e)} style={{ flexShrink: 0 }}>
                  <span />
                  <span />
                </a>
              </div>
