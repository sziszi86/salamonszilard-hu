export const de = {
  ...
  age: '39 Jahre alt',
  location: 'Schattendorf, Österreich',
  personalDescription: 'Ich bin ein ehrgeiziger und fröhlicher junger Mann voller Ideen und Pläne',
  mobility: 'Teilweise bewegungseingeschränkt mit leichten Sprechschwierigkeiten',
  ...
  brandDesign: 'Markendesign',
  webDevelopmentService: 'Webentwicklung',
